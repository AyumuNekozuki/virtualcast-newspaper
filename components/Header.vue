      ...
      <nav class="navigation">
        <div class="wrap wide">
          ...
          <div class="wrap_right">
            <nuxt-link class="header_links blue" to="/newest">最新刊を読む</nuxt-link>
          </div>
        </div>
        <div class="wrap solid">
          <div class="wrap_left">
            ...
            <a href="https://virtualcast.jp/" target="_blank">
              バーチャルキャスト<font-awesome-icon :icon="['fas','external-link-alt']" />
            </a>
            <a href="https://seed.online/" target="_blank">
              THE SEED ONLINE<font-awesome-icon :icon="['fas','external-link-alt']" />
            </a>
            <a href="https://id.pokemori.jp/vcas-calendar/" target="_blank">
              Vキャスイベカレ<font-awesome-icon :icon="['fas','external-link-alt']" />
            </a>
          </div>
          <div class="wrap_right">
            <a
...
.navigation .wrap.solid .wrap_left {
  display: flex;
}
...
.navigation .wrap.solid .wrap_left a:not(:last-child)::after {
  content: "";
